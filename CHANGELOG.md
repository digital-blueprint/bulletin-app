...
- Added a new developer-only activity `generate-student-profiles` that creates random student profiles so more entries are shown on the browse career profiles page
